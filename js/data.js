...
const SPECIES = [
  ...
  /* ---- Sunstone expansion: cacti & succulents ---- */
  {
    id: 'saguaro', name: 'Saguaro', latin: 'Carnegiea gigantea', rarity: 'legendary',
    shape: 'column', pal: { base: '#4f8b55', dark: '#32643b', light: '#73aa70', vein: '#f0dfae' },
    thirst: 0.28, hunger: 0.25, light: 'sun', vigor: 0.34, maxLeaves: 8, value: 720,
    varChance: 0.01, tags: ['cactus', 'columnar', 'tough', 'sunstone'],
    blurb: 'A Sonoran giant in miniature. Its first arm feels like a royal occasion.',
  },
  {
    id: 'bluetorch', name: 'Blue Torch', latin: 'Pilosocereus pachycladus', rarity: 'rare',
    shape: 'column', pal: { base: '#579b9a', dark: '#347274', light: '#87c3bb', vein: '#efe5c4' },
    thirst: 0.42, hunger: 0.34, light: 'sun', vigor: 0.58, maxLeaves: 10, value: 210,
    varChance: 0.02, tags: ['cactus', 'columnar', 'sunstone'],
    blurb: 'Powder-blue columns with honey spines. Prince Sean calls it the castle skyline.',
  },
  {
    id: 'oldman', name: 'Old Man Cactus', latin: 'Cephalocereus senilis', rarity: 'epic',
    shape: 'column', pal: { base: '#557e58', dark: '#365a3b', light: '#789b76', vein: '#f8f3df' },
    thirst: 0.35, hunger: 0.28, light: 'sun', vigor: 0.42, maxLeaves: 9, value: 390,
    varChance: 0.01, tags: ['cactus', 'columnar', 'woolly', 'sunstone'],
    blurb: 'A green column hidden under long white wool. Ancient-looking from the beginning.',
  },
  {
    id: 'fairycastle', name: 'Fairy Castle Cactus', latin: 'Acanthocereus tetragonus', rarity: 'uncommon',
    shape: 'column', pal: { base: '#3f824a', dark: '#285c34', light: '#65a466', vein: '#dfd29c' },
    thirst: 0.48, hunger: 0.32, light: 'sun', vigor: 0.74, maxLeaves: 15, value: 82,
    varChance: 0.02, tags: ['cactus', 'columnar', 'cluster', 'sunstone'],
    blurb: 'Turrets grow beside turrets until a tiny green castle fills the pot.',
  },
  {
    id: 'astrophytum', name: 'Star Cactus', latin: 'Astrophytum asterias', rarity: 'rare',
    shape: 'starcactus', pal: { base: '#66886a', dark: '#405f48', light: '#8eaa8b', vein: '#f4e9cb' },
    thirst: 0.25, hunger: 0.24, light: 'sun', vigor: 0.43, maxLeaves: 7, value: 245,
    varChance: 0.03, tags: ['cactus', 'globular', 'spotted', 'sunstone'],
    blurb: 'Eight perfect ribs dusted with white flecks, like a star seen from above.',
  },
  {
    id: 'mooncactus', name: 'Moon Cactus', latin: 'Gymnocalycium mihanovichii', rarity: 'uncommon',
    shape: 'starcactus', pal: { base: '#df5f58', dark: '#9f3439', light: '#ff9a67', vein: '#ffe4a6' },
    thirst: 0.45, hunger: 0.36, light: 'bright', vigor: 0.6, maxLeaves: 8, value: 105,
    varChance: 0.01, tags: ['cactus', 'grafted', 'globular', 'sunstone'],
    blurb: 'A jewel-bright crown grafted to a green rootstock. Shade it from the hardest sun.',
  },
  {
    id: 'fishbone', name: 'Fishbone Cactus', latin: 'Disocactus anguliger', rarity: 'rare',
    shape: 'segment', pal: { base: '#4b8d58', dark: '#2f663e', light: '#72ad72', vein: '#d7e8b0' },
    thirst: 1.25, hunger: 0.55, light: 'bright', vigor: 0.92, maxLeaves: 20, value: 180,
    varChance: 0.03, tags: ['cactus', 'trailing', 'epiphyte', 'flowers', 'sunstone'],
    blurb: 'Flat zigzag stems cascade like green lightning, followed by enormous night flowers.',
  },
  {
    id: 'rattail', name: 'Rat Tail Cactus', latin: 'Disocactus flagelliformis', rarity: 'uncommon',
    shape: 'column', pal: { base: '#4e8b52', dark: '#326438', light: '#75ad70', vein: '#e3d09f' },
    thirst: 0.75, hunger: 0.4, light: 'sun', vigor: 1.0, maxLeaves: 22, value: 78,
    varChance: 0.02, tags: ['cactus', 'trailing', 'flowers', 'sunstone'],
    blurb: 'Long bristled stems tumble over the rim and burst into magenta trumpets.',
  },
  {
    id: 'christmas', name: 'Christmas Cactus', latin: 'Schlumbergera truncata', rarity: 'common',
    shape: 'segment', pal: { base: '#4c9258', dark: '#31683e', light: '#77b373', vein: '#346b42' },
    thirst: 1.35, hunger: 0.55, light: 'bright', vigor: 1.1, maxLeaves: 24, value: 42,
    varChance: 0.04, tags: ['cactus', 'trailing', 'epiphyte', 'flowers', 'sunstone'],
    blurb: 'Scalloped joints and winter fireworks. A cactus that prefers a forest to a desert.',
  },
  {
    id: 'peanut', name: 'Peanut Cactus', latin: 'Echinopsis chamaecereus', rarity: 'uncommon',
    shape: 'column', pal: { base: '#61a14b', dark: '#427936', light: '#8bc76c', vein: '#f0dfad' },
    thirst: 0.58, hunger: 0.4, light: 'sun', vigor: 1.05, maxLeaves: 18, value: 68,
    varChance: 0.03, tags: ['cactus', 'cluster', 'flowers', 'sunstone'],
    blurb: 'A crowd of finger-sized stems that can disappear beneath scarlet flowers.',
  },
  {
    id: 'aloe', name: 'Aloe Vera', latin: 'Aloe barbadensis', rarity: 'common',
    shape: 'rosette', pal: { base: '#55966b', dark: '#347052', light: '#82b88a', vein: '#cde5b7' },
    thirst: 0.72, hunger: 0.4, light: 'sun', vigor: 0.9, maxLeaves: 16, value: 38,
    varChance: 0.04, tags: ['succulent', 'rosette', 'medicinal', 'sunstone'],
    blurb: 'Fleshy toothed spears full of cool gel. Useful, sturdy and quietly handsome.',
  },
  {
    id: 'haworthia', name: 'Zebra Haworthia', latin: 'Haworthiopsis attenuata', rarity: 'uncommon',
    shape: 'rosette', pal: { base: '#315f46', dark: '#1e4632', light: '#527b5c', vein: '#f4f1d5' },
    thirst: 0.5, hunger: 0.3, light: 'bright', vigor: 0.7, maxLeaves: 18, value: 72,
    varChance: 0.03, tags: ['succulent', 'rosette', 'striped', 'sunstone'],
    blurb: 'A dark star of pointed leaves ringed with raised porcelain stripes.',
  },
  {
    id: 'echeveria', name: 'Blue Rose Echeveria', latin: 'Echeveria imbricata', rarity: 'uncommon',
    shape: 'rosette', pal: { base: '#7a9f9e', dark: '#557778', light: '#a9c1b8', vein: '#d8dbcb' },
    thirst: 0.52, hunger: 0.35, light: 'sun', vigor: 0.68, maxLeaves: 20, value: 78,
    varChance: 0.06, tags: ['succulent', 'rosette', 'sunstone'],
    blurb: 'A powder-blue rose assembled leaf by leaf, blushing pink in hard sun.',
  },
  {
    id: 'dolphins', name: 'String of Dolphins', latin: 'Curio × peregrinus', rarity: 'rare',
    shape: 'dolphin', pal: { base: '#5d9a76', dark: '#3d7355', light: '#87b798', vein: '#d8eee0' },
    thirst: 0.85, hunger: 0.4, light: 'sun', vigor: 0.96, maxLeaves: 26, value: 145,
    varChance: 0.05, tags: ['succulent', 'trailing', 'weird', 'sunstone'],
    blurb: 'Every curved leaf looks like a tiny dolphin leaping down the strand.',
  },
  {
    id: 'euphorbia', name: 'African Milk Tree', latin: 'Euphorbia trigona', rarity: 'rare',
    shape: 'column', pal: { base: '#397c49', dark: '#245c35', light: '#5a9e5f', vein: '#e8d1a1' },
    thirst: 0.45, hunger: 0.4, light: 'sun', vigor: 0.72, maxLeaves: 13, value: 175,
    varChance: 0.08, tags: ['euphorbia', 'columnar', 'toxic', 'sunstone'],
    blurb: 'Not a cactus: a candelabra euphorbia with triangular stems and milky sap.',
  },
  /* ---- story foliage expansion ---- */
  {
    id: 'oxalis', name: 'Purple Shamrock', latin: 'Oxalis triangularis', rarity: 'uncommon',
    shape: 'triangle', pal: { base: '#583a72', dark: '#35234c', light: '#805a95', vein: '#d79ac3' },
    thirst: 2.6, hunger: 0.75, light: 'bright', vigor: 1.15, maxLeaves: 18, value: 70,
    varChance: 0.02, tags: ['nightfold', 'flowers', 'dramatic'],
    blurb: 'Three purple triangles close like umbrellas each night and wake with the sun.',
  },
  {
    id: 'maranta', name: 'Red Prayer Plant', latin: 'Maranta leuconeura', rarity: 'common',
    shape: 'oval', pal: { base: '#46764b', dark: '#2b5435', light: '#72a36a', vein: '#d35d6e' },
    thirst: 3.4, hunger: 0.75, light: 'shade', vigor: 1.1, maxLeaves: 18, value: 42,
    varChance: 0.03, tags: ['nightfold', 'humidity'],
    blurb: 'Herringbone leaves rise into prayer after dark, red veins glowing against green.',
  },
  {
    id: 'rex', name: 'Rex Begonia', latin: 'Begonia rex-cultorum', rarity: 'rare',
    shape: 'wing', pal: { base: '#596559', dark: '#333d38', light: '#8d9b89', vein: '#b34d73' },
    thirst: 3.0, hunger: 0.9, light: 'shade', vigor: 0.85, maxLeaves: 13, value: 165,
    varChance: 0.08, tags: ['iridescent', 'humidity', 'dramatic'],
    blurb: 'Asymmetric leaves spiral from silver into plum, charcoal and raspberry.',
  },
  {
    id: 'pilea', name: 'Chinese Money Plant', latin: 'Pilea peperomioides', rarity: 'common',
    shape: 'round', pal: { base: '#4a9358', dark: '#2f6b3d', light: '#76b675', vein: '#cae3b4' },
    thirst: 2.1, hunger: 0.65, light: 'bright', vigor: 1.25, maxLeaves: 20, value: 36,
    varChance: 0.04, tags: ['pups', 'fast'],
    blurb: 'Perfect green coins on long petioles, surrounded by generous little pups.',
  },
  {
    id: 'fittonia', name: 'Nerve Plant', latin: 'Fittonia albivenis', rarity: 'common',
    shape: 'oval', pal: { base: '#3e7047', dark: '#275333', light: '#649166', vein: '#f1a9bd' },
    thirst: 4.4, hunger: 0.65, light: 'shade', vigor: 1.3, maxLeaves: 24, value: 34,
    varChance: 0.03, tags: ['humidity', 'dramatic', 'groundcover'],
    blurb: 'A low quilt of leaves crossed by a luminous pink network. Faints theatrically.',
  },
  {
    id: 'strelitzia', name: 'Bird of Paradise', latin: 'Strelitzia nicolai', rarity: 'rare',
    shape: 'paddle', pal: { base: '#397d4b', dark: '#255b36', light: '#61a166', vein: '#2b5f39' },
    thirst: 2.8, hunger: 1.3, light: 'sun', vigor: 0.78, maxLeaves: 12, value: 220,
    varChance: 0.03, tags: ['tree', 'architectural'],
    blurb: 'Enormous upright paddles split naturally in the wind. A whole conservatory mood.',
  },
  {
    id: 'sundew', name: 'Cape Sundew', latin: 'Drosera capensis', rarity: 'rare',
    shape: 'rosette', pal: { base: '#83a94f', dark: '#557a37', light: '#a9c96c', vein: '#d84c65' },
    thirst: 5.2, hunger: 0.15, light: 'sun', vigor: 0.85, maxLeaves: 16, value: 155,
    varChance: 0.02, tags: ['carnivore', 'rosette', 'humidity', 'dramatic'],
    blurb: 'Ribbon leaves glitter with sticky ruby tentacles, beautiful and fatal to gnats.',
  },
];
...
const LEAF_SPECS = {
  ...
  saguaro:     { form: 'column', r: 3.8, vein: 'ribs', marks: 'spines', arms: 'saguaro' },
  bluetorch:   { form: 'column', r: 4.2, vein: 'ribs', marks: 'spines' },
  oldman:      { form: 'column', r: 4.0, vein: 'ribs', marks: 'wool' },
  fairycastle: { form: 'column', r: 3.5, vein: 'ribs', marks: 'spines' },
  astrophytum: { form: 'starcactus', r: 1.0, vein: 'ribs', marks: 'flecks' },
  mooncactus:  { form: 'starcactus', r: 1.0, vein: 'ribs' },
  fishbone:    { form: 'segment', r: 2.2, vein: 'midrib', margin: 'zigzag' },
  rattail:     { form: 'column', r: 5.2, vein: 'areole', marks: 'spines' },
  christmas:   { form: 'segment', r: 2.0, vein: 'midrib', margin: 'scallop' },
  peanut:      { form: 'column', r: 3.2, vein: 'ribs', marks: 'spines' },
  aloe:        { form: 'rosette', r: 3.0, vein: 'speck', margin: 'teeth' },
  haworthia:   { form: 'rosette', r: 2.6, vein: 'midrib', marks: 'zebra' },
  echeveria:   { form: 'rosette', r: 1.65, vein: 'midrib' },
  dolphins:    { form: 'dolphin', r: 1.4, vein: 'none' },
  euphorbia:   { form: 'column', r: 3.5, vein: 'ribs', marks: 'thorns', arms: 'candelabra' },
  oxalis:      { form: 'triangle', r: 1.0, vein: 'radial' },
  maranta:     { form: 'elliptic', r: 1.65, vein: 'chevron' },
  rex:         { form: 'wing', r: 1.25, vein: 'radial', marks: 'spiral' },
  pilea:       { form: 'coin', r: 1.0, vein: 'radial' },
  fittonia:    { form: 'elliptic', r: 1.6, vein: 'net' },
  strelitzia:  { form: 'paddle', r: 2.4, vein: 'pinnate' },
  sundew:      { form: 'rosette', r: 3.2, vein: 'midrib', marks: 'tentacles' },
};
